...
<div class="row">
<H2><B>Take A Pledge For Environment</B></H2>
<BR>
<div class="col-sm-12 ">
<div class="row">
<div class="col-sm-3 "></div>
<div class="col-sm-6 title"style="text-align:justify;font-size:20px;">
<p>Over the years the damage done to the environment has been severe, causing serious imbalance in the ecological system. What we forget is our daily consumption of paper, water, fuel and energy directly affects our natural surroundings which comes back to affect us. The more we damage the environment, the more harm we cause ourselves. Make a pledge to protect the environment that protects you. Do a bit to save the earth and restore the circle of life..</p>
</div>
<div class="col-sm-3 "></div>
</div>
</div>
...
<div class="col-sm-12 box"style="background:grey">
<div class="row">
<H2><B>Save trees, save animals and save yourself !!</B></H2>
<BR>
<div class="col-sm-12 ">
<div class="row">
...
<div class="col-sm-12 form" >
 <form action="pledgecode.php" method="post">
<div class="form-group">
<label>Full Name</label>
<input type="text" class="form-control" name="name" placeholder="full name" maxlength="50" style="width:700px;" required />
  </div>
  <div class="form-group">
<label>Email</label>
<input type="email" class="form-control"  placeholder="Email" name="email" maxlength="50" style="width:700px;" required />
  </div>
  <div>
  <b>Gender</b>
...
<input type="number" class="form-control"  placeholder="Contact No."name="contact" maxlength="15" style="width:700px;" required />
  </div>
<div class="form-group">
<label>take pledge</label>
<textarea type="Massage" class="form-control"placeholder="Take Pledge Here"name="msg" maxlength="250"  style="width:700px;" required / >
</textarea>
  </div>
  <br>
<button class="btn btn-success"style="width:700px;">Submit</button>
</form>
