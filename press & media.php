      ...
      <ul id="nav" class="nav navbar-nav navbar-left">
          ...
          <ul class="dropdown-menu">
           ...
           <P><li><a href="the founder.php">Sadhguru The founder</a></li></P>
            <P><li><a href="Approach.php">Approach</a></li></P>
...
<div class="col-sm-12"style="background:#f5f7eb;padding-top:80px;padding-bottom:10px;">
<div class="row">

<div class="col-sm-12 box1">
<div class="row">
<H2><B>Latest Interviews</H2></B>
</div>
</div>
<div class="col-sm-12 " >
...
<img img-responsive src="images\3.jpg"height="200px"width="365px"style="border:2px solid #f5f7eb;border-radius:20px;">
<br><br>
<p><h5><b>Community Mobilizer – 2016</b></h5></p>
<br>
<p>In 2016, PGH was awarded the “Community Mobilizer – 2016” award at India Today’s Safaigiri Awards in New Delhi, for increasing the green cover of the country.</p>
...
<img img-responsive src="images\3.jpg"height="200px"width="365px"style="border:2px solid #f5f7eb;border-radius:20px;">
<br><br>
<p><h5><b>LASSIB Society Honorary Award</b></h5></p>
<br>
<p>On 13th July, 2013 PGH was awarded the LASSIB Society, Honorary Award for delivering outstanding outcomes in the area of Nurturing Natural Resources.</p>
</div>
</div>
<div class="col-sm-4 ">	
<div class="col-sm-12 img1">
<img img-responsive src="images\3.jpg"height="200px"width="365px"style="border:2px solid #f5f7eb;border-radius:20px;">
<br><br>
<p><h5><b>Environmental Award – 2010</b></h5></p>
<br>
<p>On April 5th 2012, PGH was awarded the “Environmental Award – 2010” by the Department of Environment, Government of Tamil Nadu.</p>
</div>
</div>
</div>
<div class="col-sm-1 "></div>
...
<div class="col-sm-12 box1"style="background:white;" >
<div class="row">
<H2><B>Latest Interviews</H2></B>
</div>
</div>
...
<div class="col-sm-9">
<div class="col-sm-12">
<div class="col-sm-5 dropdown">search 
</div>
<div class="col-sm-4 dropdown">FILTERS</div>
<div class="col-sm-3"></div>
</div>
</div>
<div class="col-sm-3 dropdown">SHORT BY</div>
</div>
</div>
<div class="col-sm-1"></div>
</div>
