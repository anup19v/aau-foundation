...
<div class="row">
<div class="col-sm-12 box"style="background:url('images/about.jpg')" >
<div class="row">
sign up
</div>
</div>
...
<div class="col-sm-12 loginbox"style="margin:20px;">
<div class="row">
<div class="col-sm-3" style="background:rgba(255,255,255,0.5);min-height:700px;"></div>

<div class="col-sm-6" style="background:rgba(135,206,235,0.7);min-height:700px;padding:20px;">
...
<b>Username</b>
<input type="text" class="form-control logininput" placeholder="Username" name="name" maxlength="50" required /><br/></br>
<b>Email</b>
<input type="email" class="form-control logininput" placeholder="Email" name="email"/ maxlength="50" required ></br></br>
<b>Mobile</b>
...
<div class="col-sm-6">
<b> File Upload</b>
<b><input type="file" name="file" /></b><br/>
</div>
<div class="col-sm-6" >
<b>
<?php
