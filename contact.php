...
<div class="row">
<div class="col-sm-12 box"style="background:url('images/contact.jpg')">
<div class="row">
contact us
</div>
</div>
...
<input type="text" class="form-control" name="name" placeholder="full name" maxlength="50" required />
...
<input type="number" class="form-control"  placeholder="Contact No."name="mobile" maxlength="15" required />
  </div>
<div class="form-group">
<label>Massage</label>
<textarea type="Massage" class="form-control"placeholder="Enter Your Massage Here"name="msg" maxlength="250" required / ></textarea>
  </div>
  <br>
...
<p>We would love to tell you more about our project. For any queries or information, please contact:</p>
<br><br>Project GreenHands<br><br>
<i class="fa fa-home"></i> &nbsp 245, anand lok colony<br> &nbsp &nbsp &nbsp chinhat,lucknow<br><br>
<i class="fa fa-phone"></i> &nbsp Phone: + 7376987489<br> <br>
<i class="fa fa-envelope"></i> &nbsp Email: anupamv18819992gmail.com<br><br>
<button class="btn btn-success"style="width:60%;">GET DIRECTION</button>
</div>
<div class="col-sm-6">
</div>
