...
<div class="col-sm-12">
<div class="row">
<img img-responsive src="images/logo.png"height="70px"width="180px">
<img img-responsive src="images/aaa.jpg"height="70px"width="180px">
</div>
</div>
</div>
<div class="col-sm-8">
...
<nav class="navbar navbar-default" ID="menu"style="background:black;color:white;border:none;">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul id="nav" class="nav navbar-nav navbar-left">
          ...
          <ul class="dropdown-menu">
            ...
            <P><li><a href="Impact.php">Impact</a></li></P>
			...
			<P><li><a href="press & media.php">press & media</a></li></P>
          ...
          <ul class="dropdown-menu">
            <li><a href="#">add item 1</a></li>
            <P><li><a href="#">add item 2</a></li></P>
            <P><li><a href="#">add item 3</a></li></P>
            <P><li><a href="#">add item 4</a></li></P>
          </ul>
        </li>
		...
		<li><a href="#"style="color:white;">TRACK YOUR TREE</a></li>
		<li><a href="#"style="color:white;">FIND A NURSERY</a></li>
